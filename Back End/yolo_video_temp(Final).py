# USAGE
# python yolo_video_temp(Final).py --video1 videos/1.mp4 --video2 videos/2.mp4 --video3 videos/3.mp4 --video4 videos/4.mp4 --output1 output/1.avi --output2 output/2.avi --output3 output/3.avi --output4 output/4.avi --yolo yolo-coco
...
# construct the argument parse and parse the arguments 
    ...
    for i in range(4):
        ...
        cursor1.execute(
            "INSERT INTO vehicle_table(vehicleCount,today_date,start_time,end_time,signalId) VALUES ('"+total_vehicles+"','"+ today_date +"','"+ right_now +"','"+ after_hour +"','"+ str(signalno) +"')")
